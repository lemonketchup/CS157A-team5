...
<head>
	...
	<link rel="stylesheet" href="commentClass.css" type="text/css">
...
<h2>Comment on Class</h2> 

<form name ="form3" class="form3" method = "post" action = "commentClass.jsp">
	<br>
...
try { 
	...
	out.println("<br> These are your current classes<br>");
	while(rsInfo.next())
	{
